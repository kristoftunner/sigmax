...
// configuration step. It creates a namespace called `sigmax`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", sigmax::cmake::project_name, sigmax::cmake::project_version) };
