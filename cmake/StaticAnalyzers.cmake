macro(sigmax_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
...
macro(sigmax_enable_clang_tidy target WARNINGS_AS_ERRORS)
        ...
        if(NOT
           ...
           ".*Clang")
            ...
            if(NOT ("${TARGET_PCH}" STREQUAL "TARGET_PCH-NOTFOUND"))
                message(
                    SEND_ERROR "clang-tidy cannot be enabled with non-clang compiler and PCH, clang-tidy fails to handle gcc's PCH file")
            endif()
        endif()
...
macro(sigmax_enable_include_what_you_use)
